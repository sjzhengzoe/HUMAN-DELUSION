<template>
  <div class="ResultInput_components common_banner_bg">
...
export default {
  ...
  methods: {
    checkTerms() {
      ...
      this.handleSaveMobileAndEmail(this.phone, this.email);
    },
  },
};
</script>
