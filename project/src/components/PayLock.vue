<template>
  <div>
    ...
    <div class="PayLock_components common_banner_bg">
      ...
      <div class="content_box common_banner_middle flex-y f-y-c">
        <img class="img" src="../assets/PayLock_img.png" alt="" />
        <div class="text_box">
          好运网<span>诸葛老师</span>根据你的生日<span>量身定制</span>的一生婚
    ...
    <div class="banner_bg_box flex-y">
      ...
      <div class="content_box flex-y f-y-c">
        <img class="img img1" @click="toPay" src="../assets/Pay_img1.png" alt="" />
        <img class="img img2" @click="toPay" src="../assets/Pay_img2.png" alt="" />
        <img class="img img3" @click="toPay" src="../assets/Pay_img3.png" alt="" />
        <img class="img img4" src="../assets/Pay_img4.png" alt="" />
      </div>
    </div>
    <PayBottom :handleClick="toPay" />
  </div>
</template>
...
export default {
  ...
  methods: {
    toPay() {
      const { oid, id } = utils.getLocal();
      window.open(`${this.DOMAIN_PAY}/${this.payType}/?oid=${oid}&bid=${id}`, '_blank');
    },
