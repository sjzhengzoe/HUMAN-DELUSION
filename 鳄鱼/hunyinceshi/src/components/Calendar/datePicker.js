...
var Lunar = {
    ...
    lunarByBetween : function(year, between) {
        ...
        // return lunarArray;
        // console.log('计算得到的值',lunarArray)
    },
    //中文月份
    chineseMonth : function(month) {
      // console.log(中文,'month');
    ...
    toLunar : function(year, month, day) {
        // console.log('接收到的值',year, month, day)
        var yearData = this.lunarInfo[year - this.MIN_YEAR];
    ...
    toSolar : function(year, month, day) {
        ...
        switch (day){
          ...
          case '初八' : {day=8 } break;
          case '初九' : {day=9 } break;
          case '初十' : {day=10}  break;
          case '十一' : {day=11}  break;
          case '十二' : {day=12}  break;
          case '十三' : {day=13}  break;
          case '十四' : {day=14}  break;
          case '十五' : {day=15}  break;
          case '十六' : {day=16}  break;
          case '十七' : {day=17}  break;
          case '十八' : {day=18}  break;
          case '十九' : {day=19}  break;
          case '二十' : {day=20}  break;
          case '廿一' : {day=21}  break;
          case '廿二' : {day=22}  break;
          case '廿三' : {day=23}  break;
          case '廿四' : {day=24}  break;
          case '廿五' : {day=25}  break;
          case '廿六' : {day=26}  break;
          case '廿七' : {day=27}  break;
          case '廿八' : {day=28}  break;
          case '廿九' : {day=29}  break;
          case '三十' : {day=30}  break;
          case '三十一' : {day=31} break;
          default:
            break;
          }
        var yearData = this.lunarInfo[year - this.MIN_YEAR];
